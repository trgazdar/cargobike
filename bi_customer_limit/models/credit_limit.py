...
class res_pertner(models.Model):
    ...
    balance_invoice_ids = fields.One2many('account.move', 'partner_id', 'Customer move lines', domain=[('type', 'in', ['out_invoice','out_refund']),('invoice_payment_state', 'not in', ['paid']),('state','=','posted')]) 
