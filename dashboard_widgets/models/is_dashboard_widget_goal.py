...
class DashboardWidgetGoal(models.Model):
    ...
    goal_1_is_greater_than = fields.Boolean(string="Goal is greater than", default=True)
    ...
    show_python_custom_goal1_filter = fields.Boolean("Show Advanced Filtering")
    show_python_custom_goal2_filter = fields.Boolean("Show Advanced Filtering")
    python_custom_goal1_filter = fields.Char("Python Custom Goal Filter")
    python_custom_goal2_filter = fields.Char("Python Custom Goal Filter")
